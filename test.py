...
parser.add_argument(
    "--decoder_path", type=str, default="experiments/decoder_iter_160000.pth"
)
parser.add_argument(
    "--Trans_path", type=str, default="experiments/transformer_iter_160000.pth"
)
parser.add_argument(
    "--embedding_path", type=str, default="experiments/embedding_iter_160000.pth"
)
...
for content_path in content_paths:
    for style_path in style_paths:
        ...
        output_name = "{:s}/{:s}_stylized_{:s}{:s}".format(
            ...
            splitext(basename(style_path))[0],
            save_ext,
        )
